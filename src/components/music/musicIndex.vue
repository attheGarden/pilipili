          ...
          <div class="wrapper">
            <div class="wrapper_left">
              ...
              <a class="wrapper_left_item">
                ...
                max-width: 28px;margin: 0 auto">999+</i>
                <router-link style="display: block;font-size: 12px;height: 14px;line-height:14px;text-align: center;
                padding-top: 2px" to="/danceIndex">舞蹈</router-link>
              </a>
              <a class="wrapper_left_item">
                <i style="font-size: 8px;font-style: normal;display: block;height: 12px;line-height: 12px;
                text-align: center;color: #fff;background-color: rgba(255,175,201,0.8);padding: 1px 3px;border-radius: 5px;
              ...
              <a class="wrapper_left_item">
                ...
                max-width: 28px;margin: 0 auto">999+</i>
                <router-link style="display: block;font-size: 12px;height: 14px;line-height:14px;text-align: center;
                padding-top: 2px" to="/scienceIndex">科技</router-link>
              </a>
              <a class="wrapper_left_item">
                <i style="font-size: 8px;font-style: normal;display: block;height: 12px;line-height: 12px;
                text-align: center;color: #fff;background-color: rgba(255,175,201,0.8);padding: 1px 3px;border-radius: 5px;
              ...
              <a class="wrapper_left_item">
                ...
                max-width: 28px;margin: 0 auto">999+</i>
                <router-link style="display: block;font-size: 12px;height: 14px;line-height:14px;text-align: center;
                padding-top: 2px" to="/lifeIndex">生活</router-link>
              </a>
              <a class="wrapper_left_item">
                <i style="font-size: 8px;font-style: normal;display: block;height: 12px;line-height: 12px;
                text-align: center;color: #fff;background-color: rgba(255,175,201,0.8);padding: 1px 3px;border-radius: 5px;
                ...
                <router-link style="display: block;font-size: 12px;height: 14px;line-height:14px;text-align: center;
                padding-top: 2px" to="/guichuIndex">鬼畜</router-link>
              </a>
              <a class="wrapper_left_item">
                <i style="font-size: 8px;font-style: normal;display: block;height: 12px;line-height: 12px;
                text-align: center;color: #fff;background-color: rgba(255,175,201,0.8);padding: 1px 3px;border-radius: 5px;
                ...
                <router-link style="display: block;font-size: 12px;height: 14px;line-height:14px;text-align: center;
                padding-top: 2px" to="/fashionIndex">时尚</router-link>
              </a>
              <a class="wrapper_left_item">
                <i style="font-size: 8px;font-style: normal;display: block;height: 12px;line-height: 12px;
                text-align: center;color: #fff;background-color: rgba(255,175,201,0.8);padding: 1px 3px;border-radius: 5px;
              ...
              <a class="wrapper_left_item">
                ...
                max-width: 28px;margin: 0 auto">999+</i>
                <router-link style="display: block;font-size: 12px;height: 14px;line-height:14px;text-align: center;
                padding-top: 2px" to="/entertainmentIndex">娱乐</router-link>
              </a>
              <a class="wrapper_left_item">
                <i style="font-size: 8px;font-style: normal;display: block;height: 12px;line-height: 12px;
                text-align: center;color: #fff;background-color: rgba(255,175,201,0.8);padding: 1px 3px;border-radius: 5px;
                max-width: 28px;margin: 0 auto">999+</i>
                <router-link style="display: block;font-size: 12px;height: 14px;line-height:14px;text-align: center;
                padding-top: 2px" to="/movieIndex">影视</router-link>
              </a>
              <a class="wrapper_left_item">
                <i style="font-size: 8px;font-style: normal;display: block;height: 12px;line-height: 12px;
                text-align: center;color: #fff;background-color: rgba(255,175,201,0.8);padding: 1px 3px;border-radius: 5px;
      ...
      <div class="part_content_box">
        <div class="part_content">
          ...
          <div style="margin-top: 20px;margin-bottom: 40px">
            <img src="https://i0.hdslb.com/bfs/sycp/creative_img/201906/e38519ada07422ea0e0f65ae6bd216fe.jpg" width="1160px"/>
          </div>
          <index_part :id="26" :tag_id="26"></index_part>
          <index_part :id="27" :tag_id="27"></index_part>
          <index_part :id="28" :tag_id="28"></index_part>
        </div>
      </div>
